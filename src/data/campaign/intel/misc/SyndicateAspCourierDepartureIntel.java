...
public final class SyndicateAspCourierDepartureIntel extends BaseIntelPlugin {
    ...
    protected final void initTransientData() {
        ...
        if ("items".equals(cargoType)) {
            items = true;
        } else if ("prisoner".equals(cargoType)) {
            prisoner = true;
        } else if ("money".equals(cargoType)) {
            money = true;
        } else if ("vip".equals(cargoType)) {
            vip = true;
        }
